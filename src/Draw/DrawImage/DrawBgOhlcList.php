...
use EmpiricaPlatform\Draw\Helper\FontHelper;
use EmpiricaPlatform\Draw\HistoryData\OhlcList;
use EmpiricaPlatform\Draw\DrawImage\Exception\DrawBgOhlcListException;
...
class DrawBgOhlcList extends DrawOhlcList {
	...
	public function __construct(DrawOhlcList $drawOhlcList) {
